...
<main id="apropos">
    ...
    <?php
    echo do_shortcode('[banniere-titre titre="À propos de BricoTips" src="http://localhost:8888/bricotips/wp-content/uploads/2025/10/banniere-image.webp"]')
    ?>
    ...
    <section id="quisuisje">
        ...
        <div class="image">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/autor.jpg"
    ...
    <section id="bricolage">
        ...
        <div class="image">
            <img
                src="<?php echo get_stylesheet_directory_uri(); ?>/images/brico.jpg"
                alt="bricolage" />
        </div>
        <div class="text">
